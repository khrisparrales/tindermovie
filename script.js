...
document.body.onload = initCards;
...
function apiCall() {
    ...
    $.getJSON('https://www.omdbapi.com/?i=tt3896198&apikey=f1d6c99&s=batman&page=1').then(function(response) {
...
function creartarjetas() {
    ...
    var currentDiv = document.getElementById("tarjetas");
